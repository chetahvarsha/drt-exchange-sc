...
ESDT_ISSUE_ADDRESS="drt1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzllls6prdez"
ROUTE_ADDRESS="drt1qqqqqqqqqqqqqpgq9s7ft5fj72zyt8qn8yd24xcl8rxu9v4m0n4s0rqhfe"
WEGLD_WRAP_ADDRESS="drt1qqqqqqqqqqqqqpgqnqf6qpnd7y3m6wpkur9u8hg37rvhn5ae0n4syzgdjm"
...
deployWEGLDContract() {
    erdpy --verbose contract deploy --recall-nonce \
          ...
          --proxy=${PROXY} --chain=${CHAIN_ID} \
          --metadata-payable \
          --bytecode="/home/numbat/Numbat/sc-bridge-numbat/egld-esdt-swap/output/egld-esdt-swap.wasm" \
